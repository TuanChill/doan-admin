...
const QuanLyVe = () => {
    const [data, setData] = useState([
        {
            ...
            price: "40.000đ",
            type: "Vé lẻ",
            description: "Áp dụng cho khách từ 18 tuổi trở lên. Có hiệu lực trong ngày.",
          ...
          },
          {
            ...
            price: "20.000đ",
            type: "Vé lẻ",
            description: "Áp dụng cho trẻ em từ 6 đến 17 tuổi. Miễn phí cho trẻ dưới 6 tuổi.",
            create_at: "10/03/2024",
            update_at: "12/03/2024",
          },
          {
            ...
            price: "150.000đ",
            type: "Vé đoàn",
            description: "Dành cho đoàn từ 10 người trở lên. Hướng dẫn viên miễn phí.",
            create_at: "10/03/2024",
            update_at: "12/03/2024",
          },
    ]);
    ...
    const handleSearch = () => {
        const filtered = data.filter((item) => {
          const matchesName = item.name.toLowerCase().includes(searchFilters.name.trim().toLowerCase());
          const matchesType = item.type.toLowerCase().includes(searchFilters.type.trim().toLowerCase());
